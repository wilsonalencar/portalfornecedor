                    ...
                    <form class="col s12" action="{{ action('FornecedoresController@create') }}" method="post" name="cad_fornecedor">
                      <div class="row">
                        ...
                        <label for="razao_social">Razão Social</label>
                          <input id="razao_social" type="text" name="razao_social" maxlength="255" class="validate" value="">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col s3">
                        <label for="nome_fantasia">Nome Fantasia</label>
                          <input type="text" id="nome_fantasia" name="nome_fantasia" class="validate" maxlength="30" value="">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col s3">
                      ...
                      <div class="row">
                        ...
                        <label for="cnpj_cpf">CNPJ/CPF</label>
                          <input type="text" id="cpfcnpj" name="cnpj_cpf" value="" maxlength="18" class="validate">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col s6">
